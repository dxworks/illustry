...
export class Heatmap {
    ...
    populate() {
        ...
        const unitHeight = this._height / ((d - 1) / 5 + this._mapHeight);
    ...
    _finalize(depth) {
        ...
        this._data.descendants().forEach(n => {
            ...
            if(n.data){
            if(n.data.group === "passive"){
            n.color ="yellow"
            }
            else {
                if(n.data.group === "active"){
                    n.color ="green"
                    }
                    else {
                        if(n.data.group === "retired"){
                            n.color ="blue"
                            }
                            else
                            n.color = '#e2e2e2' 
