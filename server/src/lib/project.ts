...
export const createProjectfromExtern = (
  projectName: string,
...
export const createIllustryProject = (
...
export const updateProjectfromEtern = (
  projectName: string,
  projectDescription: string,
  next: any
) => {
...
export const getOneProjectfromEtern = (projectName: string, next: any) => {
  return Promise.resolve().then(() => {
    return findOneProject(projectName, next);
  });
};
