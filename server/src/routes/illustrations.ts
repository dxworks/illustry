...
router.post('/api/external/oneillustration', illustrationMiddleware.findOneIllustrationFromOtherSource)
...
router.post('/api/all/external/illustration', illustrationMiddleware.findAllIllustrationFromOtherSource)
